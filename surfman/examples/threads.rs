...
#[cfg(not(target_os = "android"))]
use winit::event::{Event, DeviceEvent, KeyboardInput, VirtualKeyCode, WindowEvent};
#[cfg(not(target_os = "android"))]
...
fn main() {
    ...
    let logical_size =
        PhysicalSize::new(window_size.width as f64, window_size.height as f64).to_logical::<f64>(dpi);
